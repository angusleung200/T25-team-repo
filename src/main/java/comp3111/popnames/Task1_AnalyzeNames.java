...
public class Task1_AnalyzeNames {
	...
	/**
	 * Task1
	 * read csv file function by input year
	 * 
	 */
	...
	/**
	 * Task1
	 * find top N names function and return a 2D array of top N male names or girl names
	 * 
	 */
	...
	public static String getSummary(int year, int topN) {
		...
		oReport += String.format(" %s of total female births in ", topN_F[0][2]);
		oReport += String.format("%d.\n", year);
	...
	/**
	 * Task1
	 * generate and return a data table for male names
	 * 
	 */
	...
	/**
	 * Task1
	 * generate and return a data table for female names
	 * 
	 */
	...
	/**
	 * Task1
	 * generate and show the bar chart for male names
	 * 
	 */
	...
	/**
	 * Task1
	 * generate and show the bar chart for female names
	 * 
	 */
	...
	public static void showBarChart_F(int year, int topN) {
	    ...
	    BarChart<String, Integer> bar_chart = new BarChart(xaxis, yaxis);  
	    bar_chart.setTitle("Top " + topN + " Names (female) in " + year);
	...
	/**
	 * Task1
	 * generate and show the pie chart for male names
	 * 
	 */
	...
	/**
	 * Task1
	 * generate and show the pie chart for female names
	 * 
	 */
	...
	public static boolean checkEmpty_T1(String year, String topN) {
		if(year == ""  || topN == "" ) {
